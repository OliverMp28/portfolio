        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12">
          ...
          <div className="max-w-md">
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Soy un desarrollador apasionado por crear soluciones innovadoras y eficientes. Con experiencia en diversas
              tecnologías web, disfruto enfrentando nuevos desafíos y aprendiendo constantemente. Mi objetivo es
              combinar creatividad y funcionalidad para desarrollar aplicaciones que marquen la diferencia.
            </p>
            <div className="flex justify-center gap-8">
              <div className="text-center">
                <FaCode className="text-3xl text-blue-500 dark:text-blue-400 mb-2 mx-auto" />
                <p className="text-sm text-gray-600 dark:text-gray-400">Código Limpio</p>
              </div>
              <div className="text-center">
                <FaCoffee className="text-3xl text-indigo-500 dark:text-indigo-400 mb-2 mx-auto" />
                <p className="text-sm text-gray-600 dark:text-gray-400">Amante del Café</p>
              </div>
              <div className="text-center">
